import type { PresetKey, RoiInput } from "./types";

export type RoiPreset = RoiInput & {
  key: PresetKey;
  name: string;
  autoOT: boolean;
};

export const defaultInput: RoiInput = {
  peoplePerDay: 50,
  daysPerMonth: 26,
  minutesPerPerson: 4,
  waitMinutes: 2,
...
export const roiPresets: Record<PresetKey, RoiPreset> = {
  default: {
    ...defaultInput,
    key: "default",
    name: "Default",
